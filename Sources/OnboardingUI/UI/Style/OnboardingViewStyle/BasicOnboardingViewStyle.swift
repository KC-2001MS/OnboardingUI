//
//  BasicOnboardingViewStyle.swift
//  OnboardingUI
//
...
public struct BasicOnboardingViewStyle: OnboardingViewStyle {
...
@available(iOS 18, macOS 15, tvOS 18, visionOS 2, *)
@available(watchOS, unavailable)
extension OnboardingViewStyle where Self == BasicOnboardingViewStyle {
    /// The regular About view style to use with an About view.
    public static var basic: BasicOnboardingViewStyle {
        return BasicOnboardingViewStyle()
    }
}
